...
* [Whether or not the operation be invoked without a Resource](http://hl7.org/fhir/dstu2/operationdefinition-definitions.html#OperationDefinition.system){:target="_blank"}
...
* This resource can be retrieved by URL or from the OperationDefinition resource for the specific FHIR server. For example, both of these URLs work:
