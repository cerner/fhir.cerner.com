...
`schedule.actor`  | Yes when using `slot-type` | [`reference`]  | A single or comma separated list of Practitioner references. Example: `Practitioner/2578010`
`-location`       | Yes when using `slot-type` | [`reference`]  | A single or comma separated list of Location references. Example: `633867`
