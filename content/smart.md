...
Even though we have support for Edge browser some clients my still be using IE due to delayed upgrades or app compatibility issues therefor it is recommended that the embedded SMART app uses functions that work correctly for both IE, and Edge at this time.
