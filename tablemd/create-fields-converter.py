...
create = json.loads(fileContent)
file.close()

if (create.get('table_name') != 'create'):
  sys.exit
...
resourceName = create.get('name')
first = True

for field in create.get('fields'):
...
content.append('        # Create Operations')
content.append('')
## insert summary text from md

content.append('      operationId: millennium' + specVersion.upper() + resourceName.replace(' ', '') + 'Create')
...
content.append('        - name: createBody')
content.append('          in: body')
content.append('          required: true')
content.append('          schema:')
content.append('            $ref: "#/definitions/CreateBody"')
...
content.append('              type: string')
content.append('              description: |')
content.append('                The URL location of the created entity.')
content.append('                ')
content.append('                Example: `https://fhir-ehr-code.cerner.com/' + specVersion + '/ec2458f2-1e24-41c8-b71b-0e701af7583d/' + resourceName + '/642774`')
